...
const content = {
  tr: {
    ...
    helpText: 'Teknik bir sorun nedeniyle uygulama içi silme işlemini gerçekleştiremiyorsanız, hesabınıza kayıtlı e-posta adresi ile support@outfitai.app adresine "HESAP SİLME TALEBİ" konu başlığıyla bir e-posta gönderin. Kimliğiniz doğrulandıktan sonra silme işlemi tarafımızca başlatılır.',
  ...
  en: {
    ...
    helpText: 'If you are unable to complete in-app deletion due to a technical issue, send an email to support@outfitai.app with the subject "ACCOUNT DELETION REQUEST" from the email address registered to your account. Deletion will be initiated after identity verification.',
