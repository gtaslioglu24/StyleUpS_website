    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Ödeme bilgileri: StyleUpS ücretsizdir, uygulama içi satın alma sunmaz ve ödeme bilgisi toplamaz.',
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          'Yüklenen görseller dosya başına 3 MB\'den küçük olmalıdır.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Payment information: StyleUpS is free, offers no in-app purchases, and does not collect payment information.',
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          'Uploaded images must be smaller than 3 MB per file.',
